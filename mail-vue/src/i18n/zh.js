const zh = {
    ...
    linuxdoBinding: 'LinuxDo绑定',
    bindLinuxDo: '绑定LinuxDo',
    unbindLinuxDo: '解绑LinuxDo',
    unbindLinuxDoConfirm: '确定要解绑LinuxDo账号吗？',
    bindLinuxDoAfterReg: '是否现在绑定LinuxDo账号？绑定后可以使用LinuxDo账号快速登录。',
    delAccount: '删除账户',
