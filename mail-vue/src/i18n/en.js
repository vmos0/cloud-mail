const en = {
    ...
    emailAutoDeleteDesc: 'Automatically delete emails after the specified number of days, except starred emails.',
    ...
    unbindGithubConfirm: 'Are you sure you want to unbind your GitHub account?',
    unbindSuccessMsg: 'Unbound successfully',
    bindGithubAfterReg: 'Bind your GitHub account now? You can quickly sign in with GitHub after binding.',
    linuxdoBinding: 'LinuxDo Binding',
    bindLinuxDo: 'Bind LinuxDo',
    unbindLinuxDo: 'Unbind LinuxDo',
    unbindLinuxDoConfirm: 'Are you sure you want to unbind your LinuxDo account?',
    bindLinuxDoAfterReg: 'Bind your LinuxDo account now? You can quickly sign in with LinuxDo after binding.',    
    ...
    r2MaxSizeDesc: 'Set the maximum R2 storage capacity. Old attachments will be deleted automatically when the limit is exceeded.',
    r2FileExpireDays: 'Attachment Expiration',
    r2FileExpireDaysDesc: 'Set how many days attachments are kept before they are automatically deleted.',
    gbUnit: 'GB',    
    about: 'About',
    version: 'Version',
    community: 'Community',
