const en = {
    ...
    tgBotDesc: 'Emails received can be forwarded to the Tg bot',
    tgBotToken: 'Bot token',
    toBotTokenDesc: 'User chat_id multiple separate with ,',
    feishuBot: 'Feishu Bot',
    feishuBotDesc: 'Emails received can be forwarded to the Feishu custom bot or chat',
    feishuAppIdDesc: 'App ID',
    feishuAppSecretDesc: 'App Secret',
    feishuChatIdDesc: 'Receive ID (e.g. Chat ID)',
    otherEmailDesc: 'You can redirect mail to the mailbox of other service providers, which requires cloudflare verification email',
    otherEmailInputDesc: 'Multiple email address sorted by , separated',
    forwardingRulesDesc: 'Rule Forwarding only forwards emails received by the setup mailbox',
